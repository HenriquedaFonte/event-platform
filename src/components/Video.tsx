...
export function Video(props: VideoProps) {
  ...
  return (
    <div className="flex-1">
      <div className="bg-black justify-center flex items-center">
        ...
        <div className="gap-8 mt-20 grid grid-cols-2">
          ...
          >
            ...
            <div className="py-6 leading-relaxed">
              <strong className="text-2xl">Complementary materials</strong>
              <p className="text-sm text-gray-200 mt-2">
                Acquire additional material to accelerate your development.
              </p>
            </div>
          ...
          >
            ...
            <div className="py-6 leading-relaxed">
              ...
              <p className="text-sm text-gray-200 mt-2">
                Download exclusive Ignite Lab wallpapers and personalize your
                machine.
              </p>
            </div>
            <div className="h-full p-6 flex items-center">
